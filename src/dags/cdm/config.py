...
class ConfigApp():
    def __init__(self) -> None:
        ...
        self.vertica_host = str(os.getenv('VERTICA_HOST'))
        self.vertica_port = int(os.getenv('VERTICA_PORT'))
        self.vertica_user = str(os.getenv('VERTICA_USER'))
        self.vertica_password = str(os.getenv('VERTICA_PASSWORD'))
